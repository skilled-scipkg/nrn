# neuron source map: Developer Guide
...
- `src/scopmath/step.cpp` | score: 5 | matched tokens: step
...
- `src/nmodl/visitors/sympy_replace_solutions_visitor.hpp` | score: 5 | matched tokens: nmodl
- `src/nmodl/visitors/sympy_replace_solutions_visitor.cpp` | score: 5 | matched tokens: nmodl
