---
name: neuron-step-3-connect-the-cells-continued
description: This skill should be used when users ask about step 3 connect the cells continued in neuron; it prioritizes documentation references and then source inspection only for unresolved details.
---

# neuron: Step 3 Connect The Cells Continued
...
- `docs/guide/step_3_connect_the_cells_continued.rst`
